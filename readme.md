...
## 🧾 Sobre
para gerenciar estoque de produtos.
...
## Backend
Decidi utilizar NodeJS + Express + PostgreSql

- NodeJS ambiente de execução javascript server-side 
- Typescript por conta da tipagem estática
- Criarei uma API Rest, então usarei Express para enviar e receber requisições HTTP (GET POST PUT DELETE)
